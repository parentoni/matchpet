...
docker run -itd --network=matchpet-internal-network --name matchpet-rendering-server 936580475072.dkr.ecr.sa-east-1.amazonaws.com/matchpet-rendering-server
