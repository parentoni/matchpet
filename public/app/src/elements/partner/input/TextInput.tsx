...
export const TextInput = (props: TextInputProps) => {
  return (
    <div className="flex flex-col">
      ...
      <input value={props.state} placeholder={props.placeholder} id={props.title}  onChange={props.onChange} className={`rounded  w-50 border p-2 ${props.errorMessage ? "border-error  placeholder-error" : "border-gray-300"}`}></input>
