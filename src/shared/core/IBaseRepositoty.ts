...
export type RepositoryBaseResult<U> = Promise<
  Either<CommonUseCaseResult.InvalidValue | AppError.UnexpectedError | GenericError<IBaseError>, U>
>;
export type RepositorySaveResult<U> = Promise<
  Either<AppError.UnexpectedError | GenericError<IBaseError>, boolean>
>;
